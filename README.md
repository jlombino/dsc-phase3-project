...
<h2>Feature Correlation Coefficients</h2>
...
The final model can be used by SyriaTel to predict whether a customer will churn soon with <b>83% Recall</b> and 96% Precision. 
